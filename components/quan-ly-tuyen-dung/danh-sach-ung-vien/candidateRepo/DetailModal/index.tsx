...
export default function DetailCandidateModal({ onCancel }: any) {
    ...
    const handleSelectionChange = (option: SelectOptionType | null, optionsArray: SelectOptionType[]) => {
        if (option) {
            ...
            setSkills(prevSkills => [...prevSkills, option]);
        }
    };


    const [skills, setSkills] = useState<SelectOptionType[]>([]);
    const [showAdditionalSkills, setShowAdditionalSkills] = useState(false);

    function handleAddSkillClick(event: React.MouseEvent<HTMLAnchorElement>) {
        event.preventDefault();
        setShowAdditionalSkills(true);
    }
                        ...
                        <div className={`${styles.modal_content}`}>
                            ...
                            <form action="">
                                    ...
                                    <div className={`${styles.form_groups}`}>
                                        ...
                                        <div className={`${styles.input_right}`}>
                                            ...
                                            {skills.map((skill, index) => (
                                                <div key={index} className={`${styles.another_skill}`}>
                                                    ...
                                                    <div className={`${styles.icon_delete}`} onClick={() => removeSkill(index)}>
                                ...
                                <div className={`${styles.modal_footer} ${styles.footer_process}`}>
                                    <button style={{ color: '#333333' }} className={`${styles.btn_cancel}`} onClick={onCancel}>Hủy</button>
