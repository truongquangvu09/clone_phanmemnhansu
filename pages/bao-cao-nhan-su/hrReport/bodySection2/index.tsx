                ...
                <div className={`${styles.body_content}`}>
                    <div className={`${styles.content_item}`}>
                        <BodySection2
                            ...
                            img2='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_3_thang.svg'
                            img3='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_1_nam.svg'
                            img4='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_10_nam.svg'
                            img5='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_10_nam.svg'
                            img6='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_10_nam.svg'
                ...
                <div className={`${styles.body_content}`}>
                    <div className={`${styles.content_item}`}>
                        <BodySection2
                            ...
                            img1='https://phanmemnhansu.timviec365.vn/assets/images/t_images/icon-users.svg'
                            img2='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_30_tuoi.svg'
                            img3='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_45_tuoi.svg'
                            img4='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_60_tuoi.svg'
                            img5='https://phanmemnhansu.timviec365.vn/assets/images/icon-report/duoi_100_tuoi.svg'
                            details_title1='Tổng số'
                ...
                <div className={`${styles.body_content}`}>
                    <div className={`${styles.content_item}`}>
                        <BodySection2
                            ...
                            img3='https://phanmemnhansu.timviec365.vn/assets/images/t_images/icon-male.svg'
                            img4='https://phanmemnhansu.timviec365.vn/assets/images/t_images/icon-male.svg'
                            img5='https://phanmemnhansu.timviec365.vn/assets/images/t_images/icon-male.svg'
                            details_title1='Tổng số'
