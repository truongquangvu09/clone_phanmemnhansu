...
export const GetListNews = async (
  ...
  const url = process.env.NEXT_PUBLIC_BASE_URL;
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..kzprE0aFRBeONnVKgYyp8MJuM9zNsA_MVSQ2K8WHGgs";
  try {
    const response = await axios.post(
